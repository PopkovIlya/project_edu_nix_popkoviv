...
films_genres = db.Table(
    "films_genres",
    db.Column("film_id", db.Integer, db.ForeignKey("films.film_id"), nullable=False),
    db.Column("genre_id", db.Integer, db.ForeignKey("genres.genre_id"), nullable=False)
)
...
class Films(db.Model):
    ...
    released_year = db.Column(db.DateTime, nullable=False)
